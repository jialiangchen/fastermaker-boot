...
public class PermissionService {
   ...
   // private final RedisTemplate<String, Object> redisTemplate;
    ...
    public Set<String> getRolePermsFormCache(Set<String> roleCodes) {
        ...
        // 从缓存中一次性获取所有角色的权限
        List<String> roleCodesAsObjects = new ArrayList<>(roleCodes);
        List<Object> rolePermsList = cacheConfig.multiGet(SecurityConstants.ROLE_PERMS_PREFIX, roleCodesAsObjects);
