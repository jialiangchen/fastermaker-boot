package com.fastermaker.filter;
...
public class JwtValidationFilter extends OncePerRequestFilter {
    ...
    public JwtValidationFilter(CacheConfig cacheConfig,String secretKey) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            if (StrUtil.isNotBlank(token) && token.startsWith(SecurityConstants.JWT_TOKEN_PREFIX)) {
                ...
                boolean isTokenBlacklisted = Boolean.TRUE.equals(cacheConfig.containsKey(SecurityConstants.BLACKLIST_TOKEN_PREFIX + jti));
