...
public class CaptchaValidationFilter  extends OncePerRequestFilter{
    ...
    public CaptchaValidationFilter(CacheConfig cacheConfig, CodeGenerator codeGenerator) {
...
//            }
            ...
            String cacheVerifyCode = (String)cacheConfig.get(SecurityConstants.CAPTCHA_CODE_PREFIX + verifyCodeKey);
