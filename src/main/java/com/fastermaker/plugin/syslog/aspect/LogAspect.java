package com.fastermaker.plugin.syslog.aspect;
...
import com.fastermaker.common.util.IPUtils;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.fastermaker.plugin.syslog.annotation.LogAnnotation)")
