...
import com.fastermaker.modules.system.converter.DeptConverter;
import com.fastermaker.modules.system.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements SysDeptService {
     ...
     */
    @Override
    public List<DeptVO> listPage(DeptQuery queryParams) {
        // 查询参数
     ...
     */
    @Override
    public Long save(DeptForm formData) {
        // 校验部门名称是否存在
     ...
     */
    @Override
    public DeptForm getFormData(Long deptId) {
     ...
     */
    @Override
    public Long update(Long deptId, DeptForm formData) {
        // 校验部门名称/部门编号是否存在
        String code = formData.getCode();
        long count = this.count(new LambdaQueryWrapper<SysDept>()
