...
import com.fastermaker.modules.system.converter.RoleConverter;
...
import com.fastermaker.modules.system.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
     ...
     */
    @Override
    public Page<RolePageVO> listPage(RolePageQuery queryParams) {
        // 查询参数
     ...
     */
    @Override
    public RoleForm getFormData(Long roleId) {
