...
import com.fastermaker.config.property.CaptchaProperties;
import com.fastermaker.modules.system.model.dto.CaptchaResult;
import com.fastermaker.modules.system.model.dto.LoginResult;
import com.fastermaker.security.util.JwtUtils;
import com.fastermaker.enums.CaptchaTypeEnum;
...
public class AuthServiceImpl implements AuthService {
    ...
    public void logout() {
        ...
        if (StrUtil.isNotBlank(token) && token.startsWith(SecurityConstants.JWT_TOKEN_PREFIX)) {
            ...
            if (expiration != null) {
                ...
                cacheConfig.set(SecurityConstants.BLACKLIST_TOKEN_PREFIX + jti, jti, ttl);
            } else {
                // 如果exp不存在，说明Token永不过期，则永久加入黑名单
                cacheConfig.set(SecurityConstants.BLACKLIST_TOKEN_PREFIX + jti, null);
            }
        }
    ...
    public CaptchaResult getCaptcha() {
        ...
        cacheConfig.set(SecurityConstants.CAPTCHA_CODE_PREFIX + captchaKey, captchaCode,
